...
<div class="mb-8">
    ...
    <p class="text-gray-300 text-sm font-bold" style="text-shadow: 1px 1px 0px #333333;">Explore structured courses across multiple programming languages and frameworks.</p>
</div>
...
<div class="flex flex-wrap gap-3 mb-6">
    ...
    <div class="relative">
        ...
        <svg class="w-4 h-4 absolute right-3 top-1/2 -translate-y-1/2 text-white pointer-events-none" style="filter: drop-shadow(1px 1px 0px #333333);" fill="none" stroke="currentColor" viewBox="0 0 24 24">
...
<div class="text-center py-16">
    ...
    <p class="text-gray-300 font-bold" style="text-shadow: 1px 1px 0px #333333;">No modules found matching your filters.</p>
</div>
<?php else: ?>
<div class="grid md:grid-cols-2 lg:grid-cols-3 gap-5">
    <?php foreach ($modules as $module): ?>
     <a href="<?= $baseUrl ?>/modules/<?= $module['id'] ?>"
         class="group bg-surface border-4 border-gray-600 rounded-none p-6 card-hover transition-all duration-200" style="box-shadow: inset 4px 4px 0px #c6c6c6, inset -4px -4px 0px #555555;">
        <!-- Header -->
        <div class="flex items-start justify-between mb-4">
            <span class="text-3xl" style="filter: drop-shadow(2px 2px 0px #333333);"><?= $module['icon'] ?></span>
        ...
        <p class="text-sm text-gray-300 mb-4 line-clamp-2 font-bold" style="text-shadow: 1px 1px 0px #333333;"><?= htmlspecialchars($module['description']) ?></p>

        <!-- Meta -->
        <div class="flex items-center gap-4 text-xs text-gray-300 mb-4 font-bold" style="text-shadow: 1px 1px 0px #333333;">
