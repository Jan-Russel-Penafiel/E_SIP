...
<div class="flex items-center justify-between mb-6">
    ...
    <a href="<?= $baseUrl ?>/admin/challenges" class="px-4 py-2 text-sm bg-black text-white border-4 border-black rounded-none hover:bg-gray-800 transition font-bold" style="box-shadow: inset 2px 2px 0px #555, inset -2px -2px 0px #000; text-shadow: 1px 1px 0px #000;">
        ← Back to Challenges
    </a>
</div>
    ...
    <div class="bg-surface border-4 border-black rounded-none p-6 space-y-5" style="box-shadow: inset 4px 4px 0px #c6c6c6, inset -4px -4px 0px #555555;">
        ...
        <div class="grid md:grid-cols-2 gap-4">
            ...
            <div>
                ...
                <select name="language" class="w-full bg-black border-4 border-black rounded-none px-4 py-2.5 text-sm text-white focus:border-white focus:outline-none font-bold" style="box-shadow: inset 2px 2px 0px #000;">
        ...
        <div>
            ...
            <textarea name="description" rows="2"
                class="w-full bg-black border-4 border-black rounded-none px-4 py-2.5 text-sm text-white focus:border-white focus:outline-none font-bold" style="box-shadow: inset 2px 2px 0px #000;"><?= htmlspecialchars($editChallenge['description'] ?? '') ?></textarea>
        </div>
        ...
        <div class="grid md:grid-cols-4 gap-4">
            ...
            <div>
                ...
                <select name="type" class="w-full bg-black border-4 border-black rounded-none px-4 py-2.5 text-sm text-white focus:border-white focus:outline-none font-bold" style="box-shadow: inset 2px 2px 0px #000;">
        ...
        <div>
            ...
            <textarea name="instructions" rows="3"
                class="w-full bg-black border-4 border-black rounded-none px-4 py-2.5 text-sm text-white focus:border-white focus:outline-none font-bold" style="box-shadow: inset 2px 2px 0px #000;"><?= htmlspecialchars($editChallenge['instructions'] ?? '') ?></textarea>
        </div>
        ...
        <div>
            ...
            <textarea name="expected_output" rows="2"
                class="w-full bg-black border-4 border-black rounded-none px-4 py-2.5 text-sm text-white font-mono focus:border-white focus:outline-none font-bold" style="box-shadow: inset 2px 2px 0px #000;"><?= htmlspecialchars($editChallenge['expected_output'] ?? '') ?></textarea>
        </div>
        ...
        <div class="grid md:grid-cols-2 gap-4">
            <div>
                ...
                <textarea name="starter_code" rows="6"
                    class="w-full bg-black border-4 border-black rounded-none px-4 py-2.5 text-sm text-white font-mono focus:border-white focus:outline-none font-bold" style="box-shadow: inset 2px 2px 0px #000;"><?= htmlspecialchars($editChallenge['starter_code'] ?? '') ?></textarea>
            </div>
            <div>
                ...
                <textarea name="solution" rows="6"
                    class="w-full bg-black border-4 border-black rounded-none px-4 py-2.5 text-sm text-white font-mono focus:border-white focus:outline-none font-bold" style="box-shadow: inset 2px 2px 0px #000;"><?= htmlspecialchars($editChallenge['solution'] ?? '') ?></textarea>
            </div>
        </div>
        ...
        <div>
            ...
            <textarea name="test_cases_json" rows="4"
                class="w-full bg-black border-4 border-black rounded-none px-4 py-2.5 text-sm text-white font-mono focus:border-white focus:outline-none font-bold" style="box-shadow: inset 2px 2px 0px #000;"><?= htmlspecialchars(json_encode($editChallenge['test_cases'] ?? [], JSON_PRETTY_PRINT)) ?></textarea>
        </div>
        ...
        <div class="grid md:grid-cols-2 gap-4">
            <div>
                ...
                <textarea name="options_json" rows="4"
                    class="w-full bg-black border-4 border-black rounded-none px-4 py-2.5 text-sm text-white font-mono focus:border-white focus:outline-none font-bold" style="box-shadow: inset 2px 2px 0px #000;"><?= htmlspecialchars(json_encode($editChallenge['options'] ?? [], JSON_PRETTY_PRINT)) ?></textarea>
            </div>
            <div>
                ...
                <textarea name="hints_json" rows="4"
                    class="w-full bg-black border-4 border-black rounded-none px-4 py-2.5 text-sm text-white font-mono focus:border-white focus:outline-none font-bold" style="box-shadow: inset 2px 2px 0px #000;"><?= htmlspecialchars(json_encode($editChallenge['hints'] ?? [], JSON_PRETTY_PRINT)) ?></textarea>
            </div>
        </div>

        <!-- Info -->
        <div class="bg-black border-4 border-black rounded-none p-4 text-xs text-gray-300 space-y-1 font-bold" style="box-shadow: inset 2px 2px 0px #000;">
        ...
        <div class="flex items-center gap-3">
            ...
            <a href="<?= $baseUrl ?>/admin/challenges" class="px-6 py-2.5 bg-black text-white font-bold border-4 border-black rounded-none hover:bg-gray-800 transition" style="box-shadow: inset 2px 2px 0px #555, inset -2px -2px 0px #000; text-shadow: 1px 1px 0px #000;">
                Cancel
            </a>
        </div>
    </div>
