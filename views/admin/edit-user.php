...
<div class="flex items-center justify-between mb-6">
    ...
    <a href="<?= $baseUrl ?>/admin/users" class="px-4 py-2 text-sm bg-surface text-white border-4 border-black rounded-none hover:bg-gray-800 transition font-bold" style="box-shadow: inset 2px 2px 0px #555, inset -2px -2px 0px #000; text-shadow: 1px 1px 0px #000;">
        ← Back to Users
    </a>
</div>
    ...
    <div class="bg-surface border-4 border-black rounded-none p-6 space-y-5" style="box-shadow: inset 4px 4px 0px #c6c6c6, inset -4px -4px 0px #555555;">
        ...
        <div class="grid md:grid-cols-2 gap-4">
            <div>
                ...
                <select name="role" class="w-full bg-surface border-4 border-black rounded-none px-4 py-2.5 text-sm text-white focus:border-white focus:outline-none font-bold" style="box-shadow: inset 2px 2px 0px #000;">
        ...
        <div class="flex items-center gap-3">
            ...
            <a href="<?= $baseUrl ?>/admin/users" class="px-6 py-2.5 bg-surface text-white border-4 border-black rounded-none hover:bg-gray-800 transition font-bold" style="box-shadow: inset 2px 2px 0px #555, inset -2px -2px 0px #000; text-shadow: 1px 1px 0px #000;">
                Cancel
            </a>
        </div>
    </div>
