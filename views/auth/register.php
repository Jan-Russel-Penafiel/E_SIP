...
<body class="bg-black text-white min-h-screen flex items-center justify-center">
    <div class="w-full max-w-md px-6">
        ...
        <div class="text-center mb-10">
            ...
            <p class="text-gray-300 mt-2 text-sm font-bold" style="text-shadow: 2px 2px 0px #000;">Start your coding journey today</p>
        </div>
        ...
        <div class="bg-gray-800 border-4 border-black rounded-none p-8" style="box-shadow: inset 4px 4px 0px #9ca3af, inset -4px -4px 0px #374151, 8px 8px 0px #000;">
            <h2 class="text-2xl font-bold mb-6 text-white text-center" style="text-shadow: 2px 2px 0px #000;">Create Account</h2>

            <form method="POST" action="<?= $baseUrl ?>/register" class="space-y-5">
                <div>
                    <label for="username" class="block text-sm font-bold text-white mb-1.5" style="text-shadow: 1px 1px 0px #000;">Username</label>
                ...
                <div>
                    <label for="confirm_password" class="block text-sm font-bold text-white mb-1.5" style="text-shadow: 1px 1px 0px #000;">Confirm Password</label>
        ...
        <p class="text-center text-gray-300 text-sm mt-8 font-bold" style="text-shadow: 2px 2px 0px #000;">
            ...
            <a href="<?= $baseUrl ?>/login" class="text-yellow-400 hover:text-yellow-300 hover:underline font-bold">Sign in</a>
        </p>
    </div>
    <script>
        document.addEventListener('keydown', function(e) {
            if (e.ctrlKey && e.altKey && e.code === 'KeyE') {
                e.preventDefault();
                window.location.href = '<?= $baseUrl ?>/login?redirect=%2Fadmin';
            }
        });
    </script>
</body>
